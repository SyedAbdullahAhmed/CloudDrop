/**
 * Database Schema for CloudDrop
 *
 * This file defines the database structure for our CloudDrop application.
 ...
 * Files Table
 *
 * This table stores all files and folders in our CloudDrop.
